...
app = Flask(__name__)
config={
  'apiKey': "AIzaSyBJqs-_pKX3wqbT0hkgtQiIBeI2-vscryw",
  'authDomain': "securityapps-76171.firebaseapp.com",
  'projectId': "securityapps-76171",
  'storageBucket': "securityapps-76171.appspot.com",
  'messagingSenderId': "289976504486",
  'appId': "1:289976504486:web:64077a964e149a1cf62467",
  'measurementId': "G-DHF1H88HZC",
 'databaseURL': " "
}
...
def handle_gps():
    ...
    return render_template('download_main.html',lat=lat,lng=lng)


@app.route('/received_gps', methods=['POST', 'GET'])
def received_gps():
